...
#define ERROR_CODE_REQUEST_HANDLER_FAILED_INIT_ADDR_POOL             ERROR_CODE_REQUEST_HANDLER + 7

// RequestHandler
#define ERROR_CODE_INTERPRETER   (4 << ERROR_CODE_MAJOR)
#define ERROR_CODE_INTERPRETER_NOT_SUPPORTED_METHOD         ERROR_CODE_INTERPRETER + 0

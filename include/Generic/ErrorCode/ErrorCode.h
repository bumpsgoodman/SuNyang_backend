...
// HttpInterpreter
#define ERROR_CODE_INTERPRETER   (3 << ERROR_CODE_MAJOR)
#define ERROR_CODE_INTERPRETER_FAILED_CREATE_THREAD              ERROR_CODE_INTERPRETER + 0
#define ERROR_CODE_INTERPRETER_FAILED_CREATE_SOCKET              ERROR_CODE_INTERPRETER + 1
#define ERROR_CODE_INTERPRETER_FAILED_BIND_SOCKET                ERROR_CODE_INTERPRETER + 2
#define ERROR_CODE_INTERPRETER_FAILED_LISTEN_SOCKET              ERROR_CODE_INTERPRETER + 3
#define ERROR_CODE_INTERPRETER_FAILED_CREATE_EPOLL               ERROR_CODE_INTERPRETER + 4
#define ERROR_CODE_INTERPRETER_FAILED_WATCH_EPOLL_DESCRIPTER     ERROR_CODE_INTERPRETER + 5
#define ERROR_CODE_INTERPRETER_BUFFER_OVERFLOW                   ERROR_CODE_INTERPRETER + 6
#define ERROR_CODE_INTERPRETER_FAILED_INIT_ADDR_POOL             ERROR_CODE_INTERPRETER + 7
